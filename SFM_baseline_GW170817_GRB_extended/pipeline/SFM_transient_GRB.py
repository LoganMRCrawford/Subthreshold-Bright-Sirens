...
# ============================================================================
# 1. PARAMETER CONFIGURATION (static arrays, no dicts in hot path)
# ============================================================================
...
# ============================================================================
# 2. VECTORIZED LOG-PRIOR (no Python loops, fully JIT-traced)
# ============================================================================
...
for run_name, prior_type in runs:
    ...
    print(f"{run_name}: "f"Log Evidence = "f"{logzs.mean():.2f} +/- {logzs.std():.2f}")
